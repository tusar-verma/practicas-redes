...
Luego la cantidad de bits que use para secuenciar los frames será $b=\lceil log_2(SWS) \rceil$
...
$$e(f) = 1 - \frac{log_2(\frac{2*V*D}{f})}{f}$$

Y la eficiencia del frame receptor será $\frac{f-2b}{f}$
